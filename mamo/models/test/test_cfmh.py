...
class MaterialDTU10MWTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.epoxy_resin.set_props_iso(E1=4.0E+09,
                                       ...
                                       rho=1.140E+03)
        self.epoxy_resin.s11_t = 73.49E+6
        # Measured by IWES for Infusionsharz RIMR135+RIMH137
        self.epoxy_resin.cte1 = 71.66E-6  # below Tg=81C
        # self.epoxy_resin.cte1 = 198.1E-6 # above Tg=81C
        self.epoxy_resin.cte2 = self.epoxy_resin.cte1
        self.epoxy_resin.cte3 = self.epoxy_resin.cte1
        ...
        # PPG Hybon 2001
        # https://books.google.de/books?id=anppDQAAQBAJ&pg=PA760&lpg=PA760&dq=hybon+2001+cte&source=bl&ots=ruhTHTNK4j&sig=XBaM0n3Y6mhEd9KaJlW58F3riWI&hl=de&sa=X&ved=2ahUKEwi32MvLxc_eAhXE-6QKHWBvDYwQ6AEwA3oECAUQAQ#v=onepage&q=hybon%202001%20cte&f=false
        self.eglass.cte1 = 5.04E-6
        self.eglass.cte2 = self.eglass.cte1
        self.eglass.cte3 = self.eglass.cte1
        ...
        # http://www.matweb.com/search/datasheet.aspx?matguid=0afcc1d8bf514c23aa0519baae00befc&ckck=1
        self.balsa.cte1 = 2.56E-6  # radial
        self.balsa.cte2 = 3.78E-6  # tangential
        self.balsa.cte3 = 1.1E-6  # longitudinal
        ...
        self.pes.set_props_iso(E1=1.5E+10,
                               nu12=0.28,
                               rho=1370.0)
        # http://www.goodfellow.com/A/Polyethersulfone.html
        self.pes.cte1 = 55.E-6
        self.pes.cte2 = self.pes.cte1
        self.pes.cte3 = self.pes.cte1
    ...
    # 4.538640000000000000e+09 1.845000000000000000e+03
        ...
        self.uniax.pl.laminate.a1
        self.uniax.pl.laminate.a2
        self.uniax.pl.laminate.a12
        ...
        self.biax.pl.laminate.a1
        self.biax.pl.laminate.a2
        self.biax.pl.laminate.a12
        ...
        self.triax.pl.laminate.a1
        self.triax.pl.laminate.a2
        self.triax.pl.laminate.a12
